		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String strsql = Dao.checkBorrowingStr(comboBox.getSelectedIndex(), comboBox1.getSelectedIndex(),
						...
						comboBox5.getSelectedIndex(),comboBox6.getSelectedIndex(),comboBox7.getSelectedIndex(), comboBox10.getSelectedIndex(), comboBox11.getSelectedIndex(),
						comboBox12.getSelectedIndex(), comboBox13.getSelectedIndex(), comboBox14.getSelectedIndex(),
						comboBox15.getSelectedIndex(),comboBox16.getSelectedIndex(),comboBox17.getSelectedIndex(), textField.getText(), textField1.getText(), textField2.getText(),
